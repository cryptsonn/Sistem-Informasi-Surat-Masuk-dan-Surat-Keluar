...
<li><a class="app-menu__item" href="kelola_suratkeluarkd.php"><i class="app-menu__icon fa fa-paper-plane"></i>
  ...
  <main class="app-content">
    ...
    <p><a class="btn btn-primary icon-btn" href="grafiksuratmasuk.php"><i class="fa fa-book"></i>Grafik Data Surat Masuk</a>
    </p>
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                include 'koneksi.php';
                    ...
                    JOIN user USING (id_user) WHERE surat_masuk.disposisi_tujuan = '".$_SESSION['divisi']."'");
                ...
                <tr>
                  ...
                  <td><?php echo "<a class='btn btn-default btn-primary' href='cetak_suratmasuk.php?file_surat=".$suratmasuk['file_surat']."'><i class='fa fa-print'></i>Cetak Surat</a>";?></td>
