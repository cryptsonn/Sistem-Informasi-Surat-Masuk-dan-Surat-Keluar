            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                include 'koneksi.php';
                    ...
                    JOIN surat_masuk USING (id_suratm) where status IS NOT NULL AND status !='' AND surat_masuk.id_user = '".$_SESSION['id_user']."' ");
                    ...
                    <tr>
                      ...
                      <td>
                      <?php echo "<a class='btn btn-info' href='detail_tracking2.php?no_suratm=".$tracking['no_suratm']."'><i class='fa fa-eye'></i></a>";
                         ?>
