...
<li><a class="app-menu__item" href="kelola_suratkeluarsk.php"><i class="app-menu__icon fa fa-paper-plane"></i>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="app-menu__icon fa fa-users"></i> Data User</h1>
      </div>
    ...
    <p><a class="btn btn-primary icon-btn" href="tambah_user.php"><i class="fa fa-user-plus"></i>Tambah</a></p>
              ...
              <tbody>
                <?php
                    ...
                    while($karyawan = mysqli_fetch_array($query)){
                      ...
                      echo "<td>".$karyawan['lokasi_kantor']."</td>";
                      echo "<td>".$karyawan['username']."</td>";
                      echo "<td>".$karyawan['password']."</td>";
                      echo "<td>".$karyawan['hak_akses']."</td>";
                      echo "<td>";
                      echo "<div class='btn-group'>";
                      echo "<a class='btn btn-info' href='edit_user.php?id_user=".$karyawan['id_user']."'><i class='fa fa-lg fa-edit'></i></a>";
                      echo "<a class='btn btn-danger' href='hapus_user.php?id_user=".$karyawan['id_user']."'><i class='fa fa-lg fa-trash'></i></a>";
                      echo "</div>";
                      echo "</td>";
