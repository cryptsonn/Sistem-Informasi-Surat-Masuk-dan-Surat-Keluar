  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb side">
        ...
        <li class="breadcrumb-item">Detail Tracking Surat Keluar</li>
    ...
    <div class="row">
      <div class="col-md-12">
     <?php echo "<a class='btn btn-primary' href='tambah_trackingsuratk.php?no_suratk=".$_GET['no_suratk']."'><i class='fa fa-plus-circle'></i>Tambah Keterangan Tracking</a>";?>
           
            <?php echo 'Nomor Surat Keluar : '.' '.$_GET['no_suratk']; ?> 
           </br>
        <div class="tile">
          <div class="tile-body">
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                include 'koneksi.php';
                    ...
                    $query = mysqli_query($db, "SELECT  id_trackingsk, id_suratk, tracking_suratk.keterangan_trackingsk, tgl_tracking FROM `tracking_suratk`
                    JOIN surat_keluar USING (id_suratk) WHERE no_suratk='$no_suratk'");
                    while($tracking = mysqli_fetch_array($query)){ ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  <td><?php echo $tracking['tgl_tracking']; ?></td>
                  <td><?php echo $tracking['keterangan_trackingsk']; ?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
