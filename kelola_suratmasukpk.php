...
<html lang="en">
  ...
  <main class="app-content">
    ...
    <p><a class="btn btn-primary icon-btn" href="tambah_suratmasuk.php"><i class="fa fa-plus-circle"></i>Tambah</a>
    </p>
          ...
          <div class="tile-body">
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                include 'koneksi.php';
                    $no = 1;
                    $query = mysqli_query($db, "SELECT user.nama_lengkap, tgl_suratmasuk, id_suratm, no_suratm, disposisi_tujuan, file_surat, keterangan, perihal FROM `surat_masuk`
                    JOIN user USING (id_user) WHERE surat_masuk.id_user = '".$_SESSION['id_user']."'");
                ...
                <tr>
                  ...
                  <td><?php if ($suratmasuk['keterangan'] == 'Diproses')
                                         {echo "<a class='btn btn-default btn-primary' target='_blank' href='cetak_suratmasuk.php?file_surat=".$suratmasuk['file_surat']."'><i class='fa fa-print'></i>Cetak</a>";
                                         ;
                                         } else if ($suratmasuk['keterangan'] == 'terkirim') 
                                         {echo "<a class='btn btn-info' href='edit_suratmasukpk.php?id_suratm=".$suratmasuk['id_suratm']."'><i class='fa fa-lg fa-edit'></i></a>";
                                         }else if($suratmasuk['keterangan'] == 'Selesai') {echo "<a class='btn btn-default btn-primary' target='_blank' href='cetak_suratmasuk.php?file_surat=".$suratmasuk['file_surat']."'><i class='fa fa-print'></i>Cetak</a>";
                                          ; }
                                         else{}
                                        ?>
                    <?php if ($suratmasuk['keterangan'] == 'Diproses'){
                                        
                                         } else if ($suratmasuk['keterangan'] == 'terkirim') 
                                         {echo "<a class='btn btn-danger' href='hapus_suratmasuk.php?id_suratm=".$suratmasuk['id_suratm']."'><i class='fa fa-lg fa-trash'></i></a>";
