...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
     <?php echo "<a class='btn btn-primary' href='tambah_trackingsuratkpk.php?no_suratk=".$_GET['no_suratk']."'><i class='fa fa-plus-circle'></i>Tambah Keterangan Tracking</a>";?>
           
            <?php echo 'Nomor Surat Masuk : '.' '.$_GET['no_suratk']; ?> 
           </br>
        <div class="tile">
          <div class="tile-body">
