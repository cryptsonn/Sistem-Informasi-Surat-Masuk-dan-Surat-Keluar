...
if( !isset($_GET['id_trackingsk']) ){
    header('Location: ktracking_suratkeluar.php');
}

//ambil id dari query string
$id_trackingsk = $_GET['id_trackingsk'];

// buat query untuk ambil data dari database
$sql = "SELECT * FROM tracking_suratk WHERE id_trackingsk=$id_trackingsk";
...
<body class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Form Edit Tracking Surat Keluar</h1>
          
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Kelola Tracking Surat Keluar</li>
          <li class="breadcrumb-item">Edit Tracking Surat Keluar</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
                ...
                <form action="proses_edit_trackingk.php" method="POST" enctype="multipart/form-data">

                 <div class="form-group">
                    <label for="id_tracking">Id Tracking</label>
                    <input class="form-control"  type="hidden" name="id_trackingsk" value="<?php echo $tracking['id_trackingsk']?>"><small class="form-text text-muted">Id Tracking</small>
                  </div>
