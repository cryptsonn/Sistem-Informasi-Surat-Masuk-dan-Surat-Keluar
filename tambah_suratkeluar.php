...
<html lang="en">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="kelola_suratkeluarsk.php"><i
            class="app-menu__icon fa fa-paper-plane"></i><span class="app-menu__label">kelola Surat Keluar</span></a>
      </li>
        ...
        <div class="tile">
          <div class="row">
            <div class="col-lg-6">
              ...
              <form action="proses_tambah_suratkeluar.php" method="POST" enctype="multipart/form-data">

                <div class="form-group">
                  <label for="no_suratk">Nomor Surat Keluar</label>
                  <input class="form-control" type="text" name="no_suratk" placeholder="Nomor Surat Keluar" required
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="file" name="file_suratk" accept="application/pdf"
                    class="form-control" required oninvalid="this.setCustomValidity('data tidak boleh kosong')"
                ...
                <div class="form-group">
                  ...
                  <select name="id_suratm" id="id_suratm" class="form-control">
                    <?php
                                        include 'koneksi.php';
                                        $a = "SELECT user.lokasi_kantor, surat_masuk.id_suratm, surat_masuk.no_suratm, surat_masuk.disposisi_tujuan FROM `surat_masuk`
