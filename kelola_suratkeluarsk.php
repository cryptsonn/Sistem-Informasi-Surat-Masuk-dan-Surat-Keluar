    ...
    <main class="app-content">
      ...
      <!-- <div class="col-md-6"> -->
           <!--  <div class="tile-title-w-btn"> -->
              ...
              <p><a class="btn btn-primary icon-btn" href="tambah_suratkeluar.php"><i class="fa fa-plus-circle"></i>Tambah</a></p>
          ...
          <div class="tile">
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                include 'koneksi.php';
                    $no = 1;
                    $query = mysqli_query($db, "SELECT surat_keluar.id_suratk, surat_keluar.no_suratk, surat_masuk.id_suratm, surat_keluar.tgl_suratkeluar, surat_keluar.file_suratk, surat_keluar.tujuan_surat, surat_keluar.perihal, surat_masuk.no_suratm, surat_keluar.status FROM `surat_keluar`
                    JOIN surat_masuk USING (id_suratm) group by id_suratk");
                    ...
                    <tr>
                      ...
                      <td><?php if ($suratkeluar['status'] == 'Menunggu')
                                         ...
                                         echo" ";
                                         echo "<a class='btn btn-info' href='edit_suratkeluarsk.php?id_suratk=".$suratkeluar['id_suratk']."'><i class='fa fa-lg fa-edit'> Edit</i></a>";
                                         echo "<a class='btn btn-danger' href='hapus_suratkeluar.php?id_suratk=".$suratkeluar['id_suratk']."'><i class='fa fa-lg fa-trash'></i> Hapus</a>";
                                        } else if ($suratkeluar['status'] == 'Diterima') 
                                         { echo "<a class='btn btn-info' href='tambah_trackingsk.php?id_suratk=".$suratkeluar['id_suratk']."'>Tambah Tracking </a>";
                                           echo "<a class='btn btn-info' href='edit_suratkeluarsk2.php?id_suratk=".$suratkeluar['id_suratk']."'><i class='fa fa-lg fa-edit'> Edit</i></a>";
                                          echo "<a class='btn btn-default btn-primary' target='_blank' href='cetak_suratkeluar.php?file_suratk=".$suratkeluar['file_suratk']."'><i class='fa fa-print'></i> Cetak</a>";
