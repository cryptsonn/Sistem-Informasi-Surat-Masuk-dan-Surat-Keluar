            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                include 'koneksi.php';
                    ...
                    JOIN surat_masuk USING (id_suratm) where status IS NOT NULL AND status !='' ");
                    ...
                    <tr>
                      ...
                      <?php if ($tracking['status'] == 'Diproses')
                                        { echo "<a class='btn btn-info' href='detail_tracking.php?no_suratm=".$tracking['no_suratm']."'><i class='fa fa-eye'></i>Detail Tracking</a>";
                                        }else if ($tracking['status'] == 'Selesai')
                                        { echo "<a class='btn btn-info' href='detail_tracking.php?no_suratm=".$tracking['no_suratm']."'><i class='fa fa-eye'></i>Detail Tracking</a>";
                                        }else{}
                                        ?> 
                      <?php if ($tracking['status'] == 'Belum Diproses')
                                        { echo "<a class='btn btn-info' href='edit_trackingsuratm.php?id_tracking=".$tracking['id_tracking']."'><i class='fa fa-lg fa-edit'></i>Edit Status</a>";
                                          echo " ";
                                          echo "<a class='btn btn-primary' href='hapus_tracking.php?id_tracking=".$tracking['id_tracking']."'><i class='fa fa-lg fa-trash'></i></a>";
                                        }else {}
                                        ?>
                      <?php if ($tracking['status'] == 'Diproses')
                                        { echo "<a class='btn btn-info' href='edit_trackingsuratm.php?id_tracking=".$tracking['id_tracking']."'><i class='fa fa-lg fa-edit'></i>Edit Status</a>";
