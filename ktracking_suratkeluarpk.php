          ...
          <div class="tile">
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                include 'koneksi.php';
                    $no = 1;
                    $divisi=$_SESSION['lokasi_kantor'];
                    $query = mysqli_query($db, "SELECT  id_trackingsk, id_suratk, surat_keluar.no_suratk, tracking_suratk.status FROM `tracking_suratk`
                    JOIN surat_keluar USING (id_suratk) where surat_keluar.tujuan_surat='$divisi' AND tracking_suratk.status IS NOT NULL AND tracking_suratk.status !='' ");
                    ...
                    <tr>
                      ...
                      <?php if ($tracking['status'] == 'Diproses')
                                        { echo "<a class='btn btn-info' href='detail_trackingkpk.php?no_suratk=".$tracking['no_suratk']."'><i class='fa fa-eye'></i>Detail Tracking</a>";
