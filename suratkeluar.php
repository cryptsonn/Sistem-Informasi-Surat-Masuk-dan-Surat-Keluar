...
<li><a class="app-menu__item" href="kelola_suratkeluarkd.php"><i class="app-menu__icon fa fa-paper-plane"></i>
  ...
  <main class="app-content">
    ...
    <p><a class="btn btn-primary icon-btn" href="grafiksuratkeluar.php"><i class="fa fa-book"></i>Grafik Data Surat Keluar</a>
    </p>
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo "<a class='btn btn-default btn-primary' href='cetak_suratkeluar.php?file_suratk=".$suratkeluar['file_suratk']."'><i class='fa fa-print'></i>Cetak Surat</a>";?></td>
